import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, ref, watch, hasInjectionContext, inject, resolveComponent, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, resolveDynamicComponent, toRaw, isRef, isReactive, toRef, reactive, effectScope, getCurrentScope, onScopeDispose, nextTick, toRefs, markRaw, defineAsyncComponent, shallowReactive, Suspense, Fragment, readonly, useSSRContext, createApp, onErrorCaptured, onServerPrefetch, isReadonly, isShallow } from 'vue';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSuspense, ssrRenderStyle } from 'vue/server-renderer';
import { Bars3Icon, ChevronRightIcon, MagnifyingGlassIcon, GlobeAltIcon, SunIcon, MoonIcon, BellIcon, ChevronDownIcon, WrenchScrewdriverIcon, InformationCircleIcon, ShieldExclamationIcon, DocumentTextIcon, UserPlusIcon, ExclamationCircleIcon, ArrowRightOnRectangleIcon, ChevronLeftIcon, XMarkIcon, UserGroupIcon, UsersIcon, FolderIcon, QuestionMarkCircleIcon, CogIcon, ChartBarIcon, ArrowRightIcon, HomeIcon, CheckIcon } from '@heroicons/vue/24/outline';
...
const _routes = [
  {
    ...
    component: () => import('./index-CLtl7oYz.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import('./profile-B4HyMYFT.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "guest" } },
    component: () => import('./login-DKVIIRqC.mjs')
  },
  {
    name: "help",
    path: "/help",
    meta: { "middleware": "auth" },
    component: () => import('./index-CCEPIUNH.mjs')
  },
  {
    name: "settings-ui",
    path: "/settings/ui",
    meta: { "middleware": "auth" },
    component: () => import('./ui-BXRGIR-s.mjs')
  },
  {
    name: "clients-id",
    path: "/clients/:id()",
    meta: { "middleware": "auth" },
    component: () => import('./_id_-WwAblhoB.mjs')
  },
  {
    name: "clients",
    path: "/clients",
    meta: { "middleware": "auth" },
    component: () => import('./index-DWG58Nki.mjs')
  },
  {
    name: "projects-id",
    path: "/projects/:id()",
    meta: { "middleware": "auth" },
    component: () => import('./_id_-BRDIqzHH.mjs')
  },
  {
    name: "clients-create",
    path: "/clients/create",
    meta: { "middleware": "auth" },
    component: () => import('./create-r2TJCtf6.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    meta: { "middleware": "auth" },
    component: () => import('./index-DixGS72r.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import('./index-fnrMOeVE.mjs')
  },
  {
    name: "settings-theme",
    path: "/settings/theme",
    meta: { "middleware": "auth" },
    component: () => import('./theme-DSHj-7RO.mjs')
  },
  {
    name: "settings-users",
    path: "/settings/users",
    meta: { "middleware": "admin" },
    component: () => import('./users-03YftJ4t.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import('./index-v-pxULpE.mjs')
  },
  {
    name: "projects-create",
    path: "/projects/create",
    meta: { "middleware": "auth" },
    component: () => import('./create-Cw4K6Zll.mjs')
  },
  {
    name: "settings-website",
    path: "/settings/website",
    meta: { "middleware": "auth" },
    component: () => import('./website-CZChj-2t.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-Bt9sVnx-.mjs'),
  auth: () => import('./auth-mpe1Jjl8.mjs'),
  guest: () => import('./guest-g87GEMgq.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-CslIn6BF.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D0eCbvjU.mjs').then((m) => m.default || m))
};
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-c2177232><aside class="${ssrRenderClass([[
        unref(sidebarCollapsed) ? "sidebar-collapsed" : "sidebar-expanded",
        { "sidebar-transitioning": unref(sidebarTransitioning) }
      ], "fixed top-0 left-0 h-full bg-white dark:bg-gray-800 shadow-lg transition-sidebar z-40 hidden lg:block flex flex-col"])}" data-v-c2177232><div class="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-700 px-4" data-v-c2177232>`);
      if (!unref(sidebarCollapsed)) {
        _push(`<div class="flex flex-col items-center" data-v-c2177232>`);
        if (unref(showLogo) && unref(logoUrl)) {
          _push(`<div class="h-10 flex items-center" data-v-c2177232><img${ssrRenderAttr("src", unref(logoUrl))}${ssrRenderAttr("alt", unref(websiteName))} class="h-8 object-contain" data-v-c2177232></div>`);
        } else {
          _push(`<div class="text-center" data-v-c2177232><div class="text-lg font-bold text-gray-800 dark:text-white truncate" data-v-c2177232>${ssrInterpolate(unref(displayName))}</div>`);
          if (unref(displaySecondaryName)) {
            _push(`<div class="text-xs text-gray-600 dark:text-gray-400 truncate" data-v-c2177232>${ssrInterpolate(unref(displaySecondaryName))}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(`<div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" data-v-c2177232>`);
        if (unref(showLogo) && unref(logoUrl)) {
          _push(`<div data-v-c2177232><img${ssrRenderAttr("src", unref(logoUrl))}${ssrRenderAttr("alt", unref(websiteName))} class="w-8 h-8 object-contain" data-v-c2177232></div>`);
        } else {
          _push(`<div class="w-8 h-8 bg-primary-500 rounded-lg flex items-center justify-center" data-v-c2177232><span class="text-white font-bold text-sm" data-v-c2177232>${ssrInterpolate((unref(displayName) || "A").charAt(0).toUpperCase())}</span></div>`);
        }
        _push(`</div>`);
      }
      _push(`</div><nav class="flex-1 px-4 py-6 space-y-2" data-v-c2177232><!--[-->`);
      ...
      if (unref(sidebarMobileOpen)) {
        _push(`<div class="fixed inset-0 bg-black bg-opacity-50 z-40 lg:hidden" data-v-c2177232></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<aside class="${ssrRenderClass([[
        unref(sidebarMobileOpen) ? "translate-x-0" : "-translate-x-full"
      ], "fixed top-0 left-0 h-full sidebar-expanded bg-white dark:bg-gray-800 shadow-xl transition-transform duration-300 z-50 lg:hidden flex flex-col sidebar-mobile"])}" data-v-c2177232><div class="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700" data-v-c2177232><div class="flex items-center space-x-3" data-v-c2177232>`);
      if (unref(showLogo) && unref(logoUrl)) {
        _push(`<div class="h-10 flex items-center" data-v-c2177232><img${ssrRenderAttr("src", unref(logoUrl))}${ssrRenderAttr("alt", unref(websiteName))} class="h-8 object-contain" data-v-c2177232></div>`);
      } else {
        _push(`<div data-v-c2177232><div class="text-lg font-bold text-gray-800 dark:text-white" data-v-c2177232>${ssrInterpolate(unref(displayName))}</div>`);
        if (unref(displaySecondaryName)) {
          _push(`<div class="text-xs text-gray-600 dark:text-gray-400" data-v-c2177232>${ssrInterpolate(unref(displaySecondaryName))}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      }
      _push(`</div><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg" data-v-c2177232>`);
      _push(ssrRenderComponent(unref(XMarkIcon), { class: "w-5 h-5" }, null, _parent));
      _push(`</button></div><nav class="flex-1 px-4 py-6 space-y-2" data-v-c2177232><!--[-->`);
      ssrRenderList(unref(menuItems), (item) => {
        _push(ssrRenderComponent(_component_SidebarMenuItem, {
          key: item.name,
          item,
      ...
      _push(`<span class="ml-3" data-v-c2177232>${ssrInterpolate(unref(isLoading) ? "登出中..." : "登出")}</span></button></div></aside></div>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c2177232"]]);
const useI18n = () => {
...
export { __nuxt_component_0$3 as _, useI18n as a, useAuthStore as b, useHead as c, useSettingsStore as d, entry$1 as default, useRoute as e, __nuxt_component_0$2 as f, useTheme as g, useWebsiteSettingsStore as h, defineNuxtRouteMiddleware as i, useNuxtApp as j, asyncDataDefaults as k, createError as l, useAppConfig as m, navigateTo as n, useRuntimeConfig as o, useSidebarStore as p, __nuxt_component_0 as q, _sfc_main$3 as r, storeToRefs as s, _sfc_main$2 as t, useApi as u };
